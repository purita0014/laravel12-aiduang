          ...
          <div class="row justify-content-center">
            <div class="col-sm-12 col-md-5 col-lg-4 col-xl-4 order-lg-2 offset-xl-1 mb-4">
              <div class="img-wrap text-center text-md-left" data-aos="fade-up" data-aos-delay="100">
                <div class="img">
                  <img src="{{ asset('assets/img/img_v_3.jpg') }}" alt="circle image" class="img-fluid">
                </div>
              </div>
            </div>
          ...
          <div class="swiper init-swiper" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide">
                <div class="team">
                  <div class="pic">
                    <img src="{{ asset('assets/img/team/team-2.jpg') }}" alt="Image" class="img-fluid">
                  </div>
                  <h3 clas="">
              ...
              <div class="swiper-slide">
                <div class="team">
                  <div class="pic">
                    <img src="{{ asset('assets/img/team/team-4.jpg') }}" alt="Image" class="img-fluid">
                  </div>
                  <h3 clas="">
                ...
                <div class="swiper-slide">
                  <div class="testimonial mx-auto">
                    <figure class="img-wrap">
                      <img src="{{ asset('assets/img/testimonials/testimonials-1.jpg') }}" alt="Image" class="img-fluid">
                    </figure>
